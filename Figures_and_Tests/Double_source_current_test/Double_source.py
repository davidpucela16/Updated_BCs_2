...
os.chdir(directory)
directory_script='/home/pdavid/Bureau/Code/SS_auto57/2D_cartesian/Updated_BCs/Figures_and_Tests/Double_source_current_test'
...
#%%
plt.plot(array_of_dist/R_size, np.abs(FEM_q_01-Multi_q_01)/FEM_q_01, '-o', label='Small neighbourhood')
plt.plot(array_of_dist/R_size, np.abs(FEM_q_00-Multi_q_00)/FEM_q_00, '-o', label='Enlarged neighbourhood')
plt.xlabel('$d/R_{big}$')
plt.yscale('log')
plt.legend()
...
#%%
plt.plot(array_of_dist/R_size, np.abs((FEM_q_11-Multi_q_11)/FEM_q_11), '-o', label='Small neighbourhood')
plt.plot(array_of_dist/R_size, np.abs((FEM_q_10-Multi_q_10)/FEM_q_10), '-o', label='Enlarged neigbhourhood')
